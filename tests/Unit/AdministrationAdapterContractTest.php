...
final class AdministrationAdapterContractTest extends TestCase
{
    public function testTheAdapterAddsExtensionSourcesAndASeparateEntitlementsModule(): void
    {
        ...
        self::assertStringContainsString('buildCriteria()', $entitlementListComponent);
        self::assertStringContainsString("create('extension_mesh_entitlement')", $entitlementListComponent);
        ...
        self::assertStringContainsString("create('extension_mesh_entitlement')", $entitlementCreateComponent);
        self::assertStringContainsString('.save(this.form', $entitlementCreateComponent);
        ...
        self::assertStringContainsString("create('extension_mesh_entitlement')", $entitlementDetailComponent);
        self::assertStringContainsString('.get(this.entitlementId', $entitlementDetailComponent);
        self::assertStringContainsString('.save(this.form', $entitlementDetailComponent);
